...
2. Launch the application and locate your local `duckstation-qt.exe` executable when prompted.
3. Select your dumped PlayStation BIOS file in your DuckStation system settings (`SCPH-7000` or newer).
4. Load your audio tracks to convert and launch the classic PSX SoundScope visualizer!